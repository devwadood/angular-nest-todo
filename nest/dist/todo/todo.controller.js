...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Todo successfully created' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return all todos' }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get a todo by id' }),
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return the todo' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Todo successfully updated' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Todo not found' }),
    __param(0, (0, common_1.Param)('id')),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Todo successfully deleted' }),
    (0, swagger_1.ApiResponse)({ status: 404, description: 'Todo not found' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
